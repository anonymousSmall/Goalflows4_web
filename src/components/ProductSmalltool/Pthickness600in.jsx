...
import product1 from "../../assets/image/Smalltool/DEFELSKOSPECPOSITECTOR6000.png"
import specvmm from "../../assets/image/specSmalltool/Defelskospecpositec.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/DEFELSKOSPEC.pdf";
import p1 from "../../assets/image/brandsale/14.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องมือวัดความหนาผิวเคลือบ (Coating Thickness Gage) ที่มีความแม่นยำสูงจากอเมริกา ได้มาตรฐาน ISO/ASTM ใช้งานแบบไม่ทำลายชิ้นงาน (Non-destructive) วัดได้ทั้งบนเหล็ก (Ferrous) และโลหะอโลหะ (Non-Ferrous) หน้าจอสีทนทาน บันทึกข้อมูลได้ และมีโพรบให้เลือกหลากหลาย</li>
                  <li>• ความแม่นยำสูง: มีโหมด Hi-RES เพิ่มความละเอียดในการวัด มาพร้อม Certificate of Calibration ตามมาตรฐาน NIST หรือ PTB</li>
                  <li>• ใช้งานอเนกประสงค์: วัดความหนาสี, ชุบ, เคลือบ บนพื้นผิวโลหะได้ทุกชนิด (เหล็ก, อลูมิเนียม, ทองเหลือง ฯลฯ)</li>
                  <li>• โพรบเปลี่ยนได้: ตัวเครื่อง (Gage Body) สามารถใช้ร่วมกับโพรบของ DeFelsko ได้ทุกรุ่น (6000 Series)</li>
                  <li>• รวดเร็วและทนทาน: โหมด Quick-Check วัดได้มากกว่า 90 ครั้งต่อนาที จอสีขนาด 2.8 นิ้ว ทนต่อแรงกระแทก</li>
                  <li>• มาตรฐานสากล: รองรับมาตรฐาน SSPC-PA 2, ISO 19840, และ IMO PSPC 90/10</li>
                  <li>• การเชื่อมต่อ: รุ่น Advanced บันทึกค่าได้ 250,000 ข้อมูล, ต่อ USB, Wi-Fi, Bluetooth และดูผ่าน Application บนมือถือได้</li>
...
export default Pthickness600in