...
import product1 from "../../assets/image/Smalltool/vertex.png"
import specvmm from "../../assets/image/specSmalltool/VERTEXVSC-6ASPEC01.png";
...
import p1 from "../../assets/image/brandsale/15.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>หัวจับเครื่องกลึง 3 จับ (3-Jaw Self-Centering Chuck) ชนิดขันหน้า (Front Mount) ที่มีความแม่นยำสูง ทนทาน ผลิตจากเหล็กหล่อ Meehanite คุณภาพสูง เหมาะสำหรับการผลิตจำนวนมาก มีฟันจับ 2 ชุด (ใน/นอก) ความแม่นยำในการจับสูง</li>
