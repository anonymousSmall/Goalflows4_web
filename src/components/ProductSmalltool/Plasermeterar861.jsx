...
import product1 from "../../assets/image/Smalltool/smartsensorAR861.png"
import specvmm from "../../assets/image/specSmalltool/smartsensorAR861SPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/SMARTSENSORSPEC.pdf";
import p1 from "../../assets/image/brandsale/33.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                    <li>เครื่องวัดระยะเลเซอร์ (Laser Distance Meter) ที่ออกแบบมาเพื่อการวัดระยะทางที่แม่นยำและรวดเร็ว เหมาะสำหรับงานก่อสร้าง สถาปัตยกรรม และการใช้งานทั่วไป</li>
              ...
              {/* Application */}
              <div className="mb-6">
                <h3 className="font-semibold text-[#003b6e] mb-2">การคำนวณอัตโนมัติ: </h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• วัดระยะทาง (Distance)</li>
                   <li>• คำนวณพื้นที่ (Area)</li>
                  <li>• คำนวณปริมาตร (Volume)</li>
                  <li>• วัดระยะทางแบบทฤษฎีบทพิธากอรัส (Pythagorean mode)</li>
...
export default Plasermeterar861