...
import product1 from "../../assets/image/Smalltool/YAMAMOTOHR-C.png"
import specvmm from "../../assets/image/specSmalltool/YAMAMOTOHR-CSPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/YAMAMOTOHR-CSPEC.pdf";
import p1 from "../../assets/image/brandsale/23.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                    <li>ก้อนทดสอบความแข็งมาตรฐานจากญี่ปุ่นที่ใช้สำหรับสอบเทียบ (Calibration) เครื่องวัดความแข็งแบบ Rockwell (HRC) มีความแม่นยำสูง เสถียร เชื่อถือได้ตามมาตรฐาน JIS B 7730 และ ISO มีลักษณะเป็นทรงกลม (φ64 x 15 มม.) มีค่าความแข็งหลากหลายระดับ (เช่น HRC 20-60+) เพื่อตรวจสอบความแม่นยำของเครื่องมือ</li>
                    {/* <li>• ระยะการวัด: สูงสุด 50 เมตร (165 ฟุต)</li>
                    <li>• ความแม่นยำ: ประมาณ \(2\text{"mm"}\) (\(0.08\text{"นิ้ว"}\))</li>
                    <li>• การใช้งาน: ใช้งานง่ายเพียงปุ่มเดียว (Point-and-click)</li>
                    <li>• ฟังก์ชันการคำนวณ:</li>
                    <li>- การแสดงผล: หน้าจอแสดงผลขนาดใหญ่ อ่านค่าได้ชัดเจน</li>
                    <li>- ความทนทาน: ได้มาตรฐาน IP54 (กันฝุ่นและละอองน้ำ)</li>
                    <li>- ระบบปิดอัตโนมัติ: ช่วยประหยัดแบตเตอรี่</li>
                    <li>หมายเหตุ: ปัจจุบัน Fluke 414D อาจถูกทดแทนด้วยรุ่นที่ใหม่กว่า เช่น Fluke 417D [1]</li>*/}
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                    <li>• สอบเทียบ (Calibration) เครื่องวัดความแข็งระบบ Rockwell C Scale</li>
                    <li>• ตรวจสอบความเที่ยงตรงของเครื่องวัดความแข็งประจำวัน</li>
                    <li>• ใช้อ้างอิงมาตรฐานสำหรับห้องปฏิบัติการตรวจสอบวัสดุ</li>
