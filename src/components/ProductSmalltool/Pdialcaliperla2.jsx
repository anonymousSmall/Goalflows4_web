...
import product1 from "../../assets/image/Smalltool/peakcockLA-2.png"
import specvmm from "../../assets/image/specSmalltool/peakcockLA-2spec01.png";
import Stand from "../../assets/image/specSmalltool/peakcockLA-2spec02.png";
import specFile from "../../assets/image/specSmalltool/peakcockLA-2spec.pdf";
import p1 from "../../assets/image/brandsale/4.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เกจ์เวอร์เนียร์แบบหน้าปัด (Dial Caliper) แสดงประสิทธิภาพอันยอดเยี่ยมในการวัดขนาดทั้งภายในและภายนอก เช่น ความหนาของผนัง ความกว้างของร่อง เส้นผ่านศูนย์กลางของรู รวมถึงชิ้นงานที่มีรูปทรงหรือพื้นที่เข้าถึงได้ยากอย่างแม่นยำ</li>
              ...
              {/* Application */}
              <div className="mb-6">
                <h3 className="font-semibold text-[#003b6e] mb-2">ข้อดี: </h3>
                <ul className="text-sm text-gray-600 space-y-1">
                    <li>• ใช้สำหรับวัดเส้นผ่านศูนย์กลางภายนอก (Outside Diameter) และความหนา</li>
                    <li>• เหมาะสำหรับงานวัดที่ต้องการความรวดเร็ว เช่น งานยาง, เฟลท์, กระดาษ หรือชิ้นงานขนาดเล็ก</li>
                    <li>• โครงสร้างแข็งแรง ทนทาน หน้าปัดอ่านค่าง่าย</li>
                    <li>• สำหรับงานวัดที่ต้องการความละเอียดและความสะดวกในการใช้งาน</li>
...
export default Pdialcaliperla2