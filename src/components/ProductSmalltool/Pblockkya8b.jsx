...
import product1 from "../../assets/image/Smalltool/KANETECKYA8B.png"
import specvmm from "../../assets/image/specSmalltool/KANETECKYA8BSPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/KANETECKYA8BSPEC.pdf";
import p1 from "../../assets/image/brandsale/18.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• การใช้งานหลัก: ใช้สำหรับจับยึดชิ้นงานในการตรวจสอบ (Scribing), งานประกอบ, หรืองานเจาะ/เจียรเบาๆ</li>
                  <li>• โครงสร้าง: เป็นบล็อกแม่เหล็กรูปทรงเหลี่ยม (Square Type) ที่มีความแข็งแรง ทนทาน</li>
                  <li>• หน้าการดูดซับ: สามารถดูดชิ้นงานได้ 3 ด้าน คือ ด้านบน (V surface), และด้านข้างทั้งสองด้าน (End faces) ช่วยให้ทำงานได้หลากหลายมุม</li>
                  <li>• ร่อง V (V-Groove): ออกแบบให้มีร่อง V ที่แม่นยำสำหรับการจับยึดชิ้นงานทรงกลม</li>
                  <li>• ระบบ ON/OFF: มีสวิตช์เปิด-ปิดแม่เหล็กที่ใช้งานง่าย ด้ามจับสามารถถอดออกได้</li>
                  <li>• ความทนทาน: โครงสร้างป้องกันน้ำและกันน้ำมัน (Drip-proof and oil-resistant) เหมาะสำหรับสภาพแวดล้อมการทำงานจริงในโรงงาน</li>
                </ul>
              </div>
