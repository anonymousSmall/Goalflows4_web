...
import product1 from "../../assets/image/Smalltool/INSIZE1147-300.png"
import specvmm from "../../assets/image/specSmalltool/INSIZE1147-300spec01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool//INSIZE1147-300spec.pdf";
import p1 from "../../assets/image/brandsale/2.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Digital Depth Gauges with mounting holes for extension base
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องมือวัดความลึกแบบดิจิตอล (Digital Depth Gauges) มาตรฐาน DIN862 ทำจากสแตนเลส สตีล แข้ง ทนทาน จุดเด่นคือมีรูบนฐานต่อขยาย(Extension Base)เพื่อเพิ่มความมั่นคงในการวัด</li>
                  <li>• วัสดุ: สแตนเลส สตีล (Stainless Steel)</li>
                  <li>• ฐาน: ยาว 100mm มีรูสำหรับยึดฐานขยาย (Mounting holes for extension base)</li>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• เหมาะสำหรับงานวัดความลึกในพื้นที่ที่ต้องการความมั่นคงสูงโดยใช้ฐานต่อขยาย</li>
...
export default Pdepthguages1147