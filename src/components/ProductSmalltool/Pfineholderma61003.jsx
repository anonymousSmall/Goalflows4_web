...
import product1 from "../../assets/image/Smalltool/NOGA.png"
import specvmm from "../../assets/image/specSmalltool/NOGAMA61003SPEC01.png";
import Stand from "../../assets/image/specSmalltool/EISENPINGAUGESPEC02.png";
import specFile from "../../assets/image/specSmalltool/NOGAMA61003SPEC.pdf";
import p1 from "../../assets/image/brandsale/17.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            FINE ADJUSTMENT HOLDER MA61003
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นขาตั้งแม่เหล็กคุณภาพสูงสำหรับจับไดอัลเกจ (Dial Gauge) ที่มีความเสถียรสูง ล็อคจุดเดียวด้วยระบบ 3 มิติ (5 แกน) มีตัวปรับละเอียดด้านบน (Fine Adjustment) และฐานแม่เหล็กเปิด-ปิดได้ แรงยึดสูง</li>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• ระบบล็อค 3 มิติ (Central Locking): ล็อคแขนทั้งหมดด้วยลูกบิดเดียวที่จุดกลาง ใช้งานง่ายและรวดเร็ว</li>
                  <li>• ปรับละเอียดด้านบน (Fine Adjustment on Top): ตัวปรับละเอียดอยู่บริเวณหัวจับ ช่วยให้ตั้งค่าศูนย์ได้ง่ายและแม่นยำ</li>
                  <li>• การจับยึดอเนกประสงค์: ตัวจับยึด Universal Swivel Clamp สามารถจับก้านไดอัลขนาด 6 มม., 8 มม., 3/8" และ Dovetail</li>
                  <li>• ฐานแม่เหล็กทรงพลัง: ฐานเปิด-ปิดได้ (On/Off) แรงยึดประมาณ (1300N) (หรือประมาณ (292 lbs))</li>
                  <li>• โครงสร้างทนทาน: แขนและข้อต่อเป็นสีดำ ทำจากโลหะคุณภาพสูง แข็งแรงทนทาน</li>
...
export default Pfineholder61003