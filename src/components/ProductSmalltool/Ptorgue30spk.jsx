...
import product1 from "../../assets/image/Smalltool/KANON30SPK.png"
import specvmm from "../../assets/image/specSmalltool/KANON30SPKSPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/KANON30SPKSPEC.pdf";
import p1 from "../../assets/image/brandsale/24.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• เครื่องมือวัดแรงขันประเภทหัวปากตาย (Open Head) ที่ตั้งค่าแรงบิดไว้ล่วงหน้า </li>
                  <li>• ประเภทเครื่องมือ: เป็นประแจปอนด์ชนิดฟังก์ชันเดียว (Single function wrench) ที่ออกแบบมาเพื่อการใช้งานขันแรงบิดค่าเดิมซ้ำๆ</li>
                  <li>• ความแม่นยำ: มีความแม่นยำสูง ±3% ของค่าที่ตั้งไว้</li>
                  <li>• หัวปากตาย (Open Head): เหมาะสำหรับการใช้งานในพื้นที่จำกัด หรือการขันที่ใช้ร่วมกับน็อตหกเหลี่ยม</li>
                  <li>• กลไกการแจ้งเตือน: เมื่อถึงค่าแรงบิดที่ตั้งไว้ จะมีเสียง "คลิก" เพื่อเตือนผู้ใช้งาน</li>
                  <li>• เหมาะสำหรับงานซ้ำๆ: ออกแบบมาเพื่อประสิทธิภาพสูงสุดในการขันสกรูหรือน็อตในสายการผลิตที่ต้องใช้แรงบิดเท่าเดิมทุกครั้ง</li>
