...
import product1 from "../../assets/image/Smalltool/fujitool178MA.png"
import specvmm from "../../assets/image/specSmalltool/fujitool178MAspec01.png";
import Stand from "../../assets/image/specSmalltool/shinwa11215spec02.png";
import specFile from "../../assets/image/specSmalltool/fujitool178MAspec.pdf";
import p1 from "../../assets/image/brandsale/7.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องมือวัดความโค้งเว้าและนูน (Radius Gauge) ความแม่นยำสูงมาตรฐานญี่ปุ่น (Made in Japan) ผลิตจากเหล็กคุณภาพสูง โครงสร้างแบบพับเก็บได้ใช้งานสะดวก เหมาะสำหรับตรวจสอบรัศมีงานชิ้นส่วนเครื่องจักรกลและแม่พิมพ์</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• ใช้ตรวจสอบรัศมีนูน (Convex) และเว้า (Concave)</li>
                  <li>• ใช้ในงานแม่พิมพ์, งานตรวจสอบคุณภาพ, งานเครื่องกล</li>
...
export default Pradiusgauge178ma