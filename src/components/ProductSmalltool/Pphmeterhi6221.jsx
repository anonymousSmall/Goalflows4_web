...
import specFile from "../../assets/image/specSmalltool/HANNAHI6221-02SPEC.pdf";
import p1 from "../../assets/image/brandsale/28.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            PH METER BENCH TOP HI6221
        </h1>
        <p className="text-gray-500 mt-2 text-sm md:text-base">
            Research Grade pH/ORP Meter with CAL Check
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องวัดค่า pH/ORP แบบตั้งโต๊ะระดับวิจัย (Research Grade) จาก Hanna Instruments โดดเด่นด้วยหน้าจอสัมผัสขนาดใหญ่ 7 นิ้ว มีเทคโนโลยี CAL Check™ ช่วยตรวจสอบหัววัด (Probe) ระหว่างสอบเทียบเพื่อความแม่นยำสูง วัดค่าได้ครอบคลุมทั้ง pH, ORP (mV) และอุณหภูมิ</li>
                  <li>• เทคโนโลยี CAL Check™: วิเคราะห์สภาพหัววัดและแจ้งเตือนผู้ใช้งานเกี่ยวกับปัญหาที่อาจเกิดขึ้นระหว่างการสอบเทียบ เพื่อการวัดที่แม่นยำที่สุด</li>
                  <li>• ความละเอียดสูง: สามารถเลือกความละเอียด pH ได้สูงสุด 3 ตำแหน่ง (0.001 pH)</li>
                  <li>• การสอบเทียบ: สอบเทียบ pH ได้สูงสุด 5 จุด</li>
                  <li>• การเชื่อมต่อ: รองรับการเชื่อมต่อข้อมูล USB และ RS232 เพื่อการจัดการข้อมูลที่สมบูรณ์</li>
                  <li>• การประยุกต์ใช้งาน: เหมาะสำหรับงานห้องปฏิบัติการขั้นสูง การควบคุมคุณภาพอาหาร เครื่องสำอาง และอุตสาหกรรมน้ำ</li>
                  <li>• เครื่องวัดชุดนี้มาพร้อมกับหัววัดอัจฉริยะ (Smart Electrode) ที่มีความทนทานและวัดค่าได้อย่างแม่นยำ</li>
