...
import product1 from "../../assets/image/Smalltool/ISSOKUPLUGGAUGE.png"
import specvmm from "../../assets/image/specSmalltool/ISSOKUPLUGGAUGESPEC01.png";
import Stand from "../../assets/image/specSmalltool/shinwa11215spec02.png";
import specFile from "../../assets/image/specSmalltool/ISSOKUSPEC.pdf";
import p1 from "../../assets/image/brandsale/10.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องมือวัดละเอียดมาตรฐานสูงจากประเทศญี่ปุ่น ผลิตจากเหล็กกล้าชุบแข็งอย่างดี ออกแบบมาเพื่อตรวจสอบขนาดเกลียวในของน็อตหรือรูเจาะอย่างแม่นยำ มีฟีเจอร์ GO/NOGO ในด้ามเดียวเพื่อแยกงานดีและงานเสียตามมาตรฐาน JIS หรือ ISO</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• ใช้ตรวจสอบระยะเกลียว (Pitch) และเส้นผ่านศูนย์กลางของเกลียวภายใน เพื่อให้มั่นใจว่าเกลียวในชิ้นงานตรงตามสเปคที่กำหนด</li>
