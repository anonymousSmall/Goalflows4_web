...
import product1 from "../../assets/image/Smalltool/CEMDT156.png"
import specvmm from "../../assets/image/specSmalltool/CEMDT156SPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/CEMDT156spec.pdf";
import p1 from "../../assets/image/brandsale/32.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                    <li>เครื่องวัดความหนาสีและผิวเคลือบบนโลหะ (Coating Thickness Tester) แบบพกพาที่แม่นยำสูง วัดได้ทั้งบนเหล็ก (Ferrous) และอลูมิเนียม/อโลหะ (Non-Ferrous) ช่วงการวัด(0- 1250um) (50 mils) ใช้งานง่าย รองรับการเชื่อมต่อ USB และบันทึกข้อมูลได้ เหมาะสำหรับตรวจสอบความหนาสีรถยนต์และงานชุบเคลือบ</li>
                    <li>• เครื่องมือนี้เหมาะสำหรับผู้ตรวจสอบคุณภาพผิวเคลือบ, อู่ซ่อมสีรถยนต์, และงานตรวจสอบวัสดุพื้นฐาน</li>
...
export default Pthicknessdt156