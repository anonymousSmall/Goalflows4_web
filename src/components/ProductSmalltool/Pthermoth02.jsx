...
import product1 from "../../assets/image/Smalltool/DIGICONTH-02.png"
import specvmm from "../../assets/image/specSmalltool/DIGICONTH-02SPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/DIGICONTH-02SPEC.pdf";
import p1 from "../../assets/image/brandsale/31.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                    <li>เครื่องวัดอุณหภูมิและความชื้นแบบดิจิตอลอิเล็กทรอนิกส์ หน้าจอ LCD ขนาดใหญ่ ใช้งานง่าย แสดงค่าอุณหภูมิและความชื้นพร้อมกัน บันทึกค่าสูงสุด-ต่ำสุดได้ ย่านวัดอุณหภูมิประมาณ (-10sim +50 C) และความชื้น (20% RH 95% RH) เหมาะสำหรับใช้งานในห้องพัก ออฟฟิศ หรือคลังสินค้า</li>
                    {/*<li>• True RMS: วัดแรงดันและกระแสไฟฟ้า AC ได้อย่างแม่นยำ</li>
                    <li>• 12 ฟังก์ชันการวัด: ได้แก่ แรงดัน AC/DC, กระแส AC/DC, ความต้านทาน (Resistance), ความจุ (Capacitance), ความถี่ (Frequency - Electrical/Electronic), อุณหภูมิ, ไดโอด และความต่อเนื่อง (Continuity)</li>
                    <li>• Data Logger: เก็บข้อมูลในตัวเครื่องได้สูงสุด 9,999 ค่า</li>
                    <li>• Wireless Interface: ส่งข้อมูลแบบ Real-time เข้าคอมพิวเตอร์ผ่าน USB receiver (ระยะประมาณ 10 เมตร/33 ฟุต)</li>
                    <li>• การแสดงผล: จอ LCD ขนาดใหญ่ แสดงผลพร้อมกันได้ 3 ค่า พร้อมไฟแบ็คไลท์</li>
                    <li>• ความแตกต่างระหว่าง EX540 และ EX542</li>
                    <li>- EX540: ใช้ความถี่ 914MHz เหมาะสำหรับอเมริกาเหนือ (สหรัฐฯ, แคนาดา, เม็กซิโก)</li>
                    <li>- EX542: ใช้ความถี่ 433MHz เหมาะสำหรับพื้นที่ส่วนใหญ่ภายนอกอเมริกาเหนือ รวมถึงประเทศไทย</li>*/}
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                    <li>• แสดงค่าอุณหภูมิและความชื้นได้พร้อมกัน</li>
                    <li>• Coating Thickness Tester</li>
                    <li>• เลือกหน่วยแสดงผลอุณหภูมิเป็นเซลเซียส หรือ ฟาเรนไฮต์</li>
                    <li>• มีสัญลักษณ์แจ้งเตือนแบตเตอรี่อ่อน</li>
