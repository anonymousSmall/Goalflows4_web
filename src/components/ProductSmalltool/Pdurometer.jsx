...
import product1 from "../../assets/image/Smalltool/teclockGS-719N.png"
import specvmm from "../../assets/image/specSmalltool/teclockGS-719Nspec01.png";
import Stand from "../../assets/image/specSmalltool/teclockGS-719Nspec02.png";
import specFile from "../../assets/image/specSmalltool/teclockGS-719Nspec.pdf";
import p1 from "../../assets/image/brandsale/3.png";
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 leading-tight">
                  Durometer Shore A(เครื่องวัดความแข็งยาง)
                </h2>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องวัดความแข็งรุ่นมาตรฐานจากญี่ปุ่น สำหรับวัดความแข็งของยางและพลาสติกอ่อน ให้ค่าที่แม่นยำ ใช้งานง่าย เหมาะสำหรับงานควบคุมคุณภาพในโรงงานและห้องปฏิบัติการ</li>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• ใช้ตรวจสอบความแข็งของยางที่ผ่านการวัดคาไนซ์ (Vulcanized Rubber)</li>
