...
import product1 from "../../assets/image/Smalltool/imadaDTXS-0.5N-Z.png"
import specvmm from "../../assets/image/specSmalltool/imadaDTXS-0.5N-Zspec01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/IMADADTXS-0.5N-ZSPEC.pdf";
import p1 from "../../assets/image/brandsale/25.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องมือวัดคุณภาพสูงจากประเทศญี่ปุ่น ที่ออกแบบมาเพื่อวัดแรงบิดในการเปิด-ปิดฝาขวด (Torque Tester) ได้อย่างแม่นยำและทำซ้ำได้ดีเยี่ยม เหมาะสำหรับการตรวจสอบคุณภาพในอุตสาหกรรมต่างๆ เช่น เครื่องดื่ม, ยา, และเครื่องสำอาง</li>
                  <li>• การสุ่มตัวอย่างรวดเร็ว: Sampling rate สูงสุดที่ 2000 Hz ช่วยจับค่าแรงบิดสูงสุด (Peak) ได้อย่างแม่นยำ แม้ในช่วงการเปลี่ยนแรงบิดที่รวดเร็ว</li>
                  <li>• การใช้งานสะดวก: หน้าจอแสดงผลดิจิตอล 4 หลัก แสดงค่าแรงบิดสูงสุดได้ทั้งการหมุนตามเข็มและทวนเข็มนาฬิกา (Clockwise/Counter-clockwise)</li>
                  <li>• หน่วยวัดหลากหลาย: สามารถเปลี่ยนหน่วยวัดได้ระหว่าง N-m, N-cm, kgf-m, kgf-cm, ozf-in, lbf-in</li>
                  <li>• การจัดการข้อมูล: มาพร้อมซอฟต์แวร์ USB Cable สำหรับเชื่อมต่อคอมพิวเตอร์เพื่อบันทึกข้อมูล (Data logging)</li>
                  <li>• ความทนทาน: โครงสร้างเซนเซอร์แบริ่งคู่ (Double bearing structure) ช่วยลดอิทธิพลของแรงดัด ทำให้ค่าที่วัดได้มีความแม่นยำ</li>
                  <li>• การใช้งานยาวนาน: แบตเตอรี่ใช้งานได้ต่อเนื่องประมาณ 8 ชั่วโมง (ชาร์จเต็ม) [1, 2, 3, 4, 5, 6]</li>
...
export default Ptorquetesterdtxs