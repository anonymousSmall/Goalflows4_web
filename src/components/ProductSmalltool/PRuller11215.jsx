...
import product1 from "../../assets/image/Smalltool/shinwa11215.png"
import specvmm from "../../assets/image/specSmalltool/shinwa11215spec01.png";
import Stand from "../../assets/image/specSmalltool/shinwa11215spec02.png";
import specFile from "../../assets/image/specSmalltool//shinwa11215spec.pdf";
import p1 from "../../assets/image/brandsale/5.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>ไม้ฉากเหล็กสแตนเลสคุณภาพสูงจากญี่ปุ่น (Thick and Wide) ขนาด 30 ซม. (300x150 มม.) ที่โดดเด่นเรื่องความแข็งแรงทนทาน หนาและกว้างกว่าปกติ เหมาะสำหรับงานโครงสร้าง งานเหล็ก และงานช่างไม้ที่ต้องการความแม่นยำสูง มาตรฐาน</li>
                  <li>• แข็งแรงและทนทาน: ผลิตจากสแตนเลสหนาและกว้างพิเศษ (Thick and Wide Type) ไม่บิดงอได้ง่าย</li>
