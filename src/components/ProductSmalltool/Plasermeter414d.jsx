...
import product1 from "../../assets/image/Smalltool/FLUKE414.png"
import specvmm from "../../assets/image/specSmalltool/FLUKE414SPEC01.png";
import Stand from "../../assets/image/specSmalltool/INSIZE1147-300spec02.png";
import specFile from "../../assets/image/specSmalltool/FLUKE414SPEC.pdf";
import p1 from "../../assets/image/brandsale/21.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                    <li> คือเครื่องวัดระยะทางด้วยเลเซอร์ระดับมืออาชีพที่ใช้งานง่ายและแม่นยำสูง วัดระยะได้ไกลถึง 50 เมตร (165 ฟุต) ด้วยความแม่นยำประมาณ 2mm (0.08 นิ้ว) เหมาะสำหรับงานติดตั้งไฟฟ้าและงานช่างทั่วไป ช่วยลดข้อผิดพลาด ประหยัดเวลาและค่าใช้จ่าย แทนการใช้ตลับเมตร</li>
...
export default Plasermeter414d