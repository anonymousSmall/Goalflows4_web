...
import product1 from "../../assets/image/Smalltool/HunterHammer22.png"
import specvmm from "../../assets/image/specSmalltool/HunterHammer22spec01.png";
import Stand from "../../assets/image/specSmalltool/HunterHammer22spec02.png";
import specFile from "../../assets/image/specSmalltool/hunterSPEC.pdf";
import p1 from "../../assets/image/brandsale/8.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Hunter Plastic Hammer/Mallet 22mm
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นค้อนพลาสติกคุณภาพสูงที่ผลิตจากประเทศเยอรมนี (Made in Germany) เหมาะสำหรับงานที่ต้องการความประณีต งานประกอบ หรือการทุบชิ้นงานโดยไม่ให้เกิดรอย</li>
