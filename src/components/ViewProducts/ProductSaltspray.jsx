...
import product1 from "../../assets/image/Productgoalflow/Salt Spray Test Chamber.png"
import specvmm from "../../assets/image/spec/SaltSprayTestChamberspec01.png";
import Stand from "../../assets/image/spec/SingleColumnElectronicUniversalTestingMachinespec02.png";
import specFile from "../../assets/image/spec/saltspraytestchamberspec.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• ตู้ทดสอบการกัดกร่อนแบบพ่นละอองเกลือ (Salt Spray Test Chamber) ใช้สำหรับประเมินความสามารถในการต้านทานการกัดกร่อนของวัสดุและชั้นเคลือบผิว รวมถึงใช้เปรียบเทียบคุณภาพของกระบวนการเคลือบผิวชนิดต่าง ๆ</li>
                  <li>• สามารถใช้ประเมินความทนทานต่อการกัดกร่อนจากไอเกลือของผลิตภัณฑ์ได้ เหมาะสำหรับชิ้นส่วน อุปกรณ์อิเล็กทรอนิกส์ ชั้นเคลือบของวัสดุโลหะ และผลิตภัณฑ์อุตสาหกรรมทั่วไป</li>
                  <li>• อุปกรณ์ประกอบด้วยระบบกระจายละอองขนาดเล็ก (Fine Droplet Dispersion System) ซึ่งทำให้การพ่นละอองเกลือมีความสม่ำเสมอ เหมาะสำหรับการทดสอบการกัดกร่อนในอุตสาหกรรมต่าง ๆ เช่น อิเล็กทรอนิกส์ ไฟฟ้า ยานยนต์ รถจักรยานยนต์ ฮาร์ดแวร์ พลาสติก แผ่นวงจรยืดหยุ่น (FPC) และผลิตภัณฑ์ชุบผิว (Electroplated Products)</li>
                  <li>• รองรับการทดสอบได้หลายรูปแบบ เช่น <br/>
-- การพ่นละอองเกลือแบบเป็นกลาง (Neutral Salt Spray Test)<br/>
-- การพ่นละอองเกลือแบบกรด (Acidic Salt Spray Test)</li>
                  <li>• เป็นอุปกรณ์ประสิทธิภาพสูงในกลุ่มตู้ทดสอบการกัดกร่อนแบบพ่นละอองเกลือ</li>
...
export default ProductSaltspray