...
import product1 from "../../assets/image/Productgoalflow/SURFACETEXTUREMEASURING.png"
import specvmm from "../../assets/image/spec/SURFACETEXTUREMEASURINGspec01.png";
import Stand from "../../assets/image/spec/SURFACETEXTUREMEASURINGspec02.png";
import specFile from "../../assets/image/spec/SURFACETEXTUREMEASURINGspec.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• High Speed & Precision:
ระบบขับเคลื่อนแบบ Magnetic Linear Drive (ไร้การสัมผัส) ช่วยให้การเคลื่อนที่รวดเร็วกว่าแบบ Spindle ทั่วไปสูงสุดถึง 7 เท่า พร้อมลดแรงสั่นสะเทือนในระดับต่ำมาก เพื่อความแม่นยำสูงในการวัด</li>
                  <li>• Performance:
รองรับช่วงการวัดแกน Z สูงสุด ±1,000 µm และมีความละเอียดแนวตั้งสูงถึง 0.0001 µm</li>
                  <li>• Versatile and Modular:
รองรับการวัดทั้งแบบ 2D และ 3D ควบคุมการทำงานด้วยระบบ CNC อัตโนมัติเต็มรูปแบบ และรองรับการใช้งานร่วมกับเซ็นเซอร์แบบ Modular</li>
                  <li>• Maintenance & Environment:
ออกแบบให้ไม่ต้องบำรุงรักษา (ไม่ใช้น้ำมัน และมีการเคลือบผิวพิเศษ) พร้อมรองรับการทำงานที่เสถียรและแม่นยำในช่วงอุณหภูมิ 20°C ± 5°C
ระบบนี้ถูกออกแบบมาสำหรับงานวิเคราะห์ค่าพื้นผิวที่ต้องการความละเอียดและความแม่นยำสูง และสามารถใช้งานร่วมกับโต๊ะกันสั่น (Anti-Vibration Table) รุ่น DX เพื่อเพิ่มประสิทธิภาพในการวัดให้ดียิ่งขึ้น</li>
...
export default ProductSurfaceTexture