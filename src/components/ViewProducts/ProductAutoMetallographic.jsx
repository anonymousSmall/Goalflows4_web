...
import product1 from "../../assets/image/Productgoalflow/Auto Metallographic Mounting Press.png"
import specvmm from "../../assets/image/spec/AutoMetallographicMountingPressSpec01.png";
import Stand from "../../assets/image/spec/AutoMetallographicMountingPressSpec02.png";
import specFile from "../../assets/image/spec/AutoMetallographicMountingPress.pdf";
...
const ProductAutoMetallographic = () => {
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Auto Metallographic Mounting Press
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• เครื่องอัดฝังชิ้นงานโลหะวิทยาแบบอัตโนมัติ ใช้ระบบแรงกดเชิงกลขับเคลื่อนด้วยมอเตอร์</li>
                  <li>• ควบคุมการทำงานด้วยโปรแกรม รองรับการทำงานแบบปุ่มเดียว ครอบคลุมขั้นตอนให้ความร้อน กดอัด รักษาแรงกด ทำความเย็น และนำชิ้นงานออก</li>
                  <li>• มอเตอร์เกียร์ ให้แรงกดสม่ำเสมอและเสถียร</li>
                  <li>• มีระบบแจ้งเตือนทั้งเสียงและแสง</li>
                  <li>• ระบบระบายความร้อนด้วยน้ำ</li>
                  <li>• ประสิทธิภาพการทำงานเสถียรและเชื่อถือได้</li>
              ...
              <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• การอัดฝังชิ้นงานเป็นขั้นตอนสำคัญในกระบวนการเตรียมตัวอย่างทางโลหะวิทยา โดยเฉพาะสำหรับชิ้นงานขนาดเล็ก จับยึดยาก หรือมีรูปทรงไม่สม่ำเสมอ รวมถึงงานที่ต้องการปกป้องขอบชิ้นงาน หรือรองรับการเจียรและขัดแบบอัตโนมัติ การอัดฝังจึงเป็นขั้นตอนที่จำเป็นก่อนการเตรียมผิวตัวอย่าง โดยรุ่น MPress-1MA ถือเป็นอุปกรณ์ที่เหมาะอย่างยิ่งสำหรับงานอัดฝังชิ้นงาน</li>
...
export default ProductAutoMetallographic