...
import product1 from "../../assets/image/Productgoalflow/METALLOGRAPHIC MANUAL GRINDER POLISHER.png"
import specvmm from "../../assets/image/spec/METALLOGRAPHICMANUALGRINDERPOLISHERspec01.png";
import Stand from "../../assets/image/spec/METALLOGRAPHICMANUALGRINDERPOLISHERspec02.png";
import specFile from "../../assets/image/spec/METALLOGRAPHIC MANUAL GRINDER POLISHER.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
         Metallographic Menual Grinder Polisher
        </h1>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <h2 className="text-lg md:text-xl font-semibold text-gray-800 leading-tight">
                  Manual Metallographic Abrasive Cutting Machine
                </h2>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• เครื่องขัดและเจียร ควบคุมด้วยระบบไมโครคอนโทรลเลอร์ (Single-chip)</li>
                  <li>• โครงสร้างเครื่องผลิตจากวัสดุ ABS ดีไซน์สวยงาม ทนทานต่อการกัดกร่อน และแข็งแรง</li>
                  <li>• แท่นเครื่องขนาดใหญ่ แข็งแรง ช่วยให้การหมุนมีความสมดุลและแม่นยำ</li>
                  <li>• ปรับความเร็วได้แบบต่อเนื่อง (Stepless) หรือเลือกได้ 4 ระดับ พร้อมปรับทิศทางการหมุนได้</li>
                  <li>• มอเตอร์ DC แบบไร้แปรงถ่าน อายุการใช้งานยาวนาน เสียงเงียบ ให้กำลังสูง เพื่อประสิทธิภาพในการเจียรและขัดที่ดียิ่งขึ้น</li>
                  <li>• ออกแบบแกนหมุนแบบป้องกันการรั่วซึม ช่วยปกป้องตลับลูกปืนจากความเสียหาย</li>
                  <li>• รองรับการเจียรแบบเปียก พร้อมระบบน้ำหล่อเย็น และท่อปรับทิศทางได้</li>
                  <li>• มีระบบล้างทำความสะอาดด้านล่างจานเจียร ช่วยป้องกันการสะสมของเศษวัสดุ</li>
                  <li>• เพียงเปลี่ยนกระดาษทรายและผ้าขัด ก็สามารถทำงานได้ครบทั้งการเจียรหยาบ เจียรละเอียด และขัดเงาชิ้นงาน</li>
                </ul>
              </div>
...
export default ProductMetallographic