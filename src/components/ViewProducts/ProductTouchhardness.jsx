...
import product1 from "../../assets/image/Productgoalflow/TOUCH SCREEN ROCKWELL HARDNESS TESTER.png"
import specvmm from "../../assets/image/spec/TOUCHSCREENROCKWELLHARDNESSTESTERspec01.png";
import Stand from "../../assets/image/spec/TOUCHSCREENROCKWELLHARDNESSTESTERspec02.png";
import specFile from "../../assets/image/spec/TOUCHSCREENROCKWELLHARDNESSTESTERspec.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• ใช้ระบบ แรงทดสอบแบบอิเล็กทรอนิกส์ (Electronic Loading) แทนระบบน้ำหนักแบบเดิม ให้ความแม่นยำสูงและค่าการวัดมีความเสถียร</li>
                  <li>• รองรับการเชื่อมต่อ Bluetooth กับคอมพิวเตอร์ เพื่อวิเคราะห์และจัดการข้อมูลผ่านซอฟต์แวร์ทดสอบความแข็งโดยเฉพาะ</li>
                  <li>• หน้าจอสัมผัสขนาด 8 นิ้ว ใช้งานง่าย พร้อมอินเทอร์เฟซที่ออกแบบให้เข้าใจง่าย (User-Friendly)</li>
                  <li>• สามารถเลือกสเกลความแข็งได้หลากหลาย เช่น Rockwell, HV, HB และรองรับการแปลงค่าสเกลต่าง ๆ ได้</li>
                  <li>• อินเทอร์เฟซใช้งานง่าย สามารถตั้งค่าพารามิเตอร์ได้สะดวก และตัวเครื่องสามารถจัดเก็บข้อมูลได้สูงสุด 500 ชุด</li>
...
export default ProductTouchhardness