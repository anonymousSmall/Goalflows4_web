...
import product1 from "../../assets/image/Productgoalflow/RONDCOM MEASURING.png"
import specvmm from "../../assets/image/spec/RONDCOMMEASURINGspec01.png";
import Stand from "../../assets/image/spec/RONDCOMMEASURINGspec02.png";
            ...
            <div>
              ...
              <div className="mb-4">
                <div className="flex items-center grid grid-cols-2 gap-2 mb-2">
                  <h3 className="font-semibold text-[#003b6e] mb-2">คุณสมบัติเด่นของ RONDCOM NEX 100 (DX/SD)</h3>
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• ความแม่นยำสูง : มีความแม่นยำในการหมุนสูงในทิศทางรัศมีระบบ CNC</li>
                  <li>• อัตโนมัติ : รองรับการจัดวางตำแหน่งชิ้นงานอัตโนมัติ (Fully automatic alignment) และสามารถเขียนโปรแกรม CNC สำหรับการวัดซ้ำ</li>
                  <li>• ฟังก์ชันการวัดที่หลากหลาย :  <br/>
  -- วัดความกลม (Roundness) และความเรียบผิว (Flatness) ได้อย่างต่อเนื่อง<br/>
  -- มีฟังก์ชันวัดเส้นผ่านศูนย์กลางตรงข้าม (Opposed diameter measurement) สำหรับวัดเส้นผ่านศูนย์กลางภายในและภายนอกได้พร้อมกัน</li>
                  <li>• รองรับชิ้นงานหลากหลาย : รองรับชิ้นงานที่สูงได้ตั้งแต่ 300, 500, ถึง 900 มม.</li>
                  <li>• เทคโนโลยีการตรวจจับ : ใช้ระบบตรวจจับอัตโนมัติ (Automatic centering and tilting) และปรับแรงอัตโนมัติ (Automatic Stylus Force)</li>
                  <li>• ระบบ AI และการวิเคราะห์: มีฟังก์ชัน AI สำหรับตั้งค่าเงื่อนไขการตรวจวัดอัตโนมัติ และบันทึกขั้นตอนการวิเคราะห์</li>
              ...
              {/* Application */}
              {/* <div className="mb-6">
                <h3 className="font-semibold text-[#003b6e] mb-2">ฟังก์ชันการวัดที่หลากหลาย :</h3>
...
export default ProductRoundness