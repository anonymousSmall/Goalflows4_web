...
import product1 from "../../assets/image/Productgoalflow/METALLOGRAPHICAUTOGRINDERPOLISHER.png"
import specvmm from "../../assets/image/spec/METALLOGRAPHICAUTOGRINDERPOLISHERspec01.png";
import Stand from "../../assets/image/spec/METALLOGRAPHICAUTOGRINDERPOLISHERspec02.png";
import specFile from "../../assets/image/spec/METALLOGRAPHICAUTOGRINDERPOLISHERspec.pdf";
...
const ProductManualMetallographic = () => {
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Metallographic Auto Grinder Polisher
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                <div className="flex items-center grid grid-cols-2 gap-2 mb-2">
                  <h3 className="font-semibold text-[#003b6e] mb-2">คุณสมบัติของเครื่อง (Features)</h3>
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• ควบคุมด้วยไมโครคอนโทรลเลอร์ (Single-chip) โครงสร้างตัวเครื่องทำจากวัสดุ ABS แข็งแรงทนทาน</li>
                  <li>• ปรับความเร็วได้แบบต่อเนื่อง (Stepless) และสามารถเลือกทิศทางการหมุนได้</li>
                  <li>• หัวขัดรองรับทั้งระบบ แรงกดแบบเดี่ยว และ แรงกดแบบศูนย์กลาง รองรับการทำงานทั้งแบบ อัตโนมัติ และ แมนนวล ในกระบวนการขัดและขัดเงา</li>
                  <li>• หน้าจอสัมผัสสีขนาด 7 นิ้ว ใช้งานง่าย แสดงผลข้อมูลชัดเจน</li>
                  <li>• สามารถตั้งค่าเวลาและความเร็วได้ พร้อมระบบจ่ายน้ำอัตโนมัติ</li>
                  <li>• ผ่นขัดออกแบบพิเศษแบบ Self-Adaptive ช่วยให้ชิ้นงานแนบสนิทกับแผ่นขัด ลดปัญหาการขัดไม่สม่ำเสมอ และให้ผิวงานมีความเรียบเท่ากัน</li>
                  <li>• ระบบล็อกหัวขัดอัตโนมัติ เพิ่มความสะดวกและความปลอดภัยในการใช้งาน</li>
                  <li>• แผ่นขัดแบบแม่เหล็ก ช่วยให้เปลี่ยนแผ่นได้รวดเร็ว พร้อมที่ยึดแบบเคลือบ Teflon ไม่ทิ้งคราบจากกระดาษทรายหรือผ้าขัด</li>
                  <li>• มอเตอร์แบบ DC Brushless อายุการใช้งานยาวนาน เสียงเงียบ และให้กำลังสูง</li>
                  <li>• สามารถบันทึกโปรแกรมได้สูงสุด 10 โปรแกรม และตั้งค่าพารามิเตอร์แยกตามชนิดตัวอย่างได้</li>
                  <li>• แผ่นขัดแบบกึ่งหมุน พร้อมระบบไฟส่องสว่างภายใน ช่วยให้หยิบวางชิ้นงานได้สะดวก</li>
                </ul>
              </div>
              ...
              {/* <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• ความแม่นยำสูง: ใช้ Linear motor drive ลดเสียงรบกวน (Noise) ได้ดีเยี่ยม</li>
...
export default ProductManualMetallographic