            ...
            <div>
              ...
              <div className="mb-4">
                <div className="flex items-center grid grid-cols-2 gap-2 mb-2">
                  <h3 className="font-semibold text-[#003b6e] mb-2">คุณสมบัติเด่น SURFCOM NEX 030 Series:</h3>
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• SURFCOM NEX 030(DX/SD) SERIES จาก Accretech (Tokyo Seimitsu) เป็นเครื่องวัดความหยาบผิวและรูปทรง (Contour) อเนกประสงค์ประสิทธิภาพสูง โดดเด่นด้วยชุดขับเคลื่อน Linear Motor ที่สั่นสะเทือนต่ำ วัดได้ละเอียดแม่นยำสูง (0.1 nm) ความเร็วสูงสุดในระดับเดียวกัน สามารถเปลี่ยนหัวตรวจวัดได้หลากหลายและใช้งานง่าย</li>
...
export default ProductContourMeasuring