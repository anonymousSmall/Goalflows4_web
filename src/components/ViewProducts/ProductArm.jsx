...
import product1 from "../../assets/image/Productgoalflow/AbsoluteArm.png"
import specvmm from "../../assets/image/spec/AbsoluteArm(CMM Arm)spec01.png";
import Stand from "../../assets/image/spec/AutoMetallographicMountingPressSpec02.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Absolute Arm 7-Axis 83 series <br/>(หรือ Absolute Arm 7-Axis รุ่น 8300 Series)
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                <div className="flex items-center grid grid-cols-2 gap-2 mb-2">
                  <h3 className="font-semibold text-[#003b6e] mb-2">คุณสมบัติหลัก (Key Features)</h3>
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>• โครงสร้าง 7 แกน (7-Axis Design): เพิ่มความคล่องตัวในการใช้งาน ช่วยให้สามารถเข้าถึงพื้นที่ที่วัดยากได้ดียิ่งขึ้น และเหมาะสำหรับการใช้งานร่วมกับเลเซอร์สแกนเนอร์</li>
                  <li>• เทคโนโลยี Absolute Encoders: เป็นจุดเด่นสำคัญ ทำให้ไม่ต้องอ้างอิงตำแหน่ง (No homing required) เปิดเครื่องแล้วสามารถใช้งานได้ทันที ช่วยลดเวลาการทำงาน</li>
                  <li>• วัสดุคาร์บอนไฟเบอร์ (Carbon Fiber Construction): โครงสร้างมีความแข็งแรงสูง น้ำหนักเบา และทนทานต่อการเปลี่ยนแปลงอุณหภูมิ (Thermal stability) ช่วยให้ความแม่นยำคงที่แม้ในสภาพแวดล้อมการทำงานที่ยากลำบาก</li>
                  <li>• ความแม่นยำสูง (High Accuracy): ผ่านการรับรองมาตรฐาน ISO 10360-12</li>
                  <li>• การใช้งานร่วมกับสแกนเนอร์ (Scanner Compatibility): 7-Axis series รองรับการใช้งานร่วมกับเลเซอร์สแกนเนอร์สมรรถนะสูง เช่น RS6 Laser Scanner, RS5 Laser Scanner, หรือ Absolute Scanner AS1</li>
              ...
              {/* Application */}
              <div className="mb-6">
                <h3 className="font-semibold text-[#003b6e] mb-2">การใช้งานทั่วไป (Common  Applications)</h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• การตรวจสอบชิ้นงานจริงเทียบกับ CAD (Part-to-CAD Inspection)</li>
                  <li>• วิศวกรรมย้อนกลับ (Reverse Engineering</li>
