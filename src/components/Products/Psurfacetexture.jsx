...
import p1 from "../../assets/image/Productgoalflow/SURFACETEXTUREMEASURING.png"
...
const products = [
  {
    id: 1,
    name: "Surface Texture Measuring Machine",
    img: p1,
    spec: specFile,
    lineid: "https://lin.ee/v7Kf7rD",
    url: "/ProductSurfaceTexture"
  },
];

const Psurfacetexture = () => {
...
export default Psurfacetexture
