...
import p1 from "../../assets/image/Productgoalflow/CONTOUR MEASURING.png"
...
const products = [
  {
    id: 1,
    name: "Contour Measuring",
    img: p1,
    spec: "",
    lineid: "https://lin.ee/v7Kf7rD",
    url: "/productcontourmeasuring"
  },
];

const Pcontourmeasuring = () => {
...
export default Pcontourmeasuring