...
import product1 from "../../assets/image/industrialbalance/EHB-SERIES.png"
import specvmm from "../../assets/image/specindustrialbalance/ehb-series1.png";
import Stand from "../../assets/image/specindustrialbalance/ehb-series2.png";
import specFile from "../../assets/image/specindustrialbalance/EHBSPEC.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งดิจิตอลความละเอียดสูง T-Scale รุ่น EHB-SERIES (Precision Balance) เป็นเครื่องชั่งทศนิยม 2และ3 ตำแหน่ง ที่เหมาะสำหรับการใช้งานในห้องแล็บ, ร้านทอง หรือการชั่งน้ำหนักสารที่ต้องการความแม่นยำสูง</li>
                  <li>• หน้าจอแสดงผล: LCD สีดำพร้อมไฟเรืองแสงสีฟ้า (Backlight) ตัวเลขสูงประมาณ 16.5 มิลลิเมตร มองเห็นชัดเจน</li>
                  {/*<li>• ปุ่มกด: แบบเมมเบรน (Membrane Keyboard) 7 ปุ่มใช้งาน </li>
                  <li>• ระบบกระจกกันลมพิเศษ: กระจกกันลมเคลือบโลหะนำไฟฟ้า ช่วยลดผลกระทบจากไฟฟ้าสถิตภายนอกได้ดี</li>
                  <li>• ระบบปรับเทียบภายใน (Internal Calibration): ปรับเทียบน้ำหนักอัตโนมัติเมื่ออุณหภูมิเปลี่ยน หรือตามเวลาที่กำหนด เพื่อความแม่นยำตลอดเวลา</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• โหมดนับจำนวนชิ้นงาน (Counting): ใช้เพื่อนับจำนวนชิ้นส่วนเล็กๆ</li>
                  <li>• โหมดคำนวณ % (Percentage): ใช้สำหรับการเทียบสัดส่วนเปอร์เซ็นต์</li>
                  <li>• ฟังก์ชันสะสมน้ำหนัก (Accumulation): สำหรับการบวกค่าน้ำหนักรวม</li>
                  <li>• การสอบเทียบ (Calibration): รองรับการทำ External Calibration เพื่อความเที่ยงตรง</li>
                  <li>• หน่วยการวัด: รองรับหน่วยที่หลากหลาย เช่น g, ct, oz, lb </li> 
                </ul>
              </div>
