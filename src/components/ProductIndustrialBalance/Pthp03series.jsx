...
import product1 from "../../assets/image/industrialbalance/THP03-SERIES.png"
import specvmm from "../../assets/image/specindustrialbalance/thp-spec1.png";
import Stand from "../../assets/image/specindustrialbalance/thp-spec2.png";
import specFile from "../../assets/image/specindustrialbalance/THP-SPEC.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            ELECTRONIC Hand Pallet THP-03-SERIES
        </h1>
        <p className="text-gray-500 mt-2 text-sm md:text-base">
            ELECTRONIC Hand Pallet
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักรถพาเลท TIGER รุ่น THP-03-SERIES เป็นเครื่องชั่งในงานอุตสาหกรรมที่รวมรถแฮนด์พาเลท (Hand Pallet) เข้ากับเครื่องชั่งดิจิตอล ความสามารถหลักคือยกและชั่งน้ำหนักได้สูงสุด (1000kg) หรือ (2000 kg) โดยมีค่าความละเอียด(0.5 kg) ถึง (1 kg) โครงสร้างแข็งแรงทนทาน ใช้จอแสดงผล LCD/LED ที่ชัดเจน</li>
                  <li>• หัวอ่าน: ใช้หัวอ่านคุณภาพสูง (มักเป็นรุ่น [TI-03SS]) ซึ่งเป็นจอ LCD/LED ตัวเลขขนาดใหญ่ 40 มม. พร้อมไฟ Backlight</li>
                  <li>• ฟังก์ชันการทำงาน: สามารถหักค่าภาชนะ (TARE), เปลี่ยนหน่วยน้ำหนัก (Kg/g), และใช้งานได้ต่อเนื่อง</li>
                  <li>• การใช้งาน: เหมาะสำหรับเคลื่อนย้ายและชั่งน้ำหนักพาเลทสินค้า ช่วยผ่อนแรงในคลังสินค้าและสายการผลิต</li>
                  <li>• รุ่นพิเศษ: มีรุ่นที่รองรับการพิมพ์ผล (Printer) เช่น THP-03P สำหรับพิมพ์ข้อมูลการชั่ง</li>
