...
import product1 from "../../assets/image/industrialbalance/TI01-SERIES.png"
import specvmm from "../../assets/image/specindustrialbalance/ti01-series1.png";
import Stand from "../../assets/image/specindustrialbalance/ti01-series2.png";
import specFile from "../../assets/image/specindustrialbalance/TI01-SPEC.pdf";
import p1 from "../../assets/image/brandsale/52.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            ELECTRONIC FLOOR SCALE TI01-SERIES 
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่ง TIGER รุ่น TI-01 Series เป็นเครื่องชั่งน้ำหนักแบบตั้งพื้นระบบดิจิตอลที่เหมาะสำหรับอุตสาหกรรม โดดเด่นด้วยจอ LED สีแดงขนาด 30 มม. อ่านค่าง่าย ชั่งได้สูงสุด 750 กิโลกรัม (หรือ 2 ตันในรุ่นใหญ่) สามารถชั่งได้ 2 หน่วย (kg/lb) มีพอร์ต RS-232 เชื่อมต่อคอมพิวเตอร์/ปริ้นเตอร์ พร้อมผ่านการตรวจรับรองจากสำนักงานชั่งตวงวัด</li>
                  <li>• หน้าจอแสดงผล: หน้าจอ LED สีแดง ขนาดตัวเลข 30 มม. มองเห็นชัดเจน</li>
                  <li>• หน่วยการชั่ง: รองรับการชั่ง 2 หน่วย คือ กิโลกรัม (kg) และ ปอนด์ (lb)</li>
                  <li>• พิกัดการชั่ง: ครอบคลุมตั้งแต่น้ำหนักเบาจนถึงพิกัดสูง (เช่น 15 กก. ถึง 750 กก. ขึ้นอยู่กับรุ่นย่อย)</li>
                  <li>• การเชื่อมต่อ: มีพอร์ต RS-232 สำหรับเชื่อมต่อกับคอมพิวเตอร์, ปริ้นเตอร์ หรือจอแสดงผลภายนอกได้</li>
                  <li>• พลังงาน: ใช้แบตเตอรี่ชนิดชาร์จไฟฟ้าได้ (Rechargeable Battery)</li>
                  <li>• มาตรฐาน: สินค้าผ่านการตรวจรับรองจากสำนักงานชั่งตวงวัด กระทรวงพาณิชย์</li>
                  <li>• โครงสร้างแท่นชั่ง: มีขนาดแท่นให้เลือกหลากหลาย</li>
                  <li>• การใช้งาน: เหมาะสำหรับอุตสาหกรรม, คลังสินค้า, หรือการชั่งพืชผลทางการเกษตรที่ต้องการความแม่นยำสูง</li>
                </ul>
              </div>
