...
import product1 from "../../assets/image/industrialbalance/T7E-SERIES.png"
import specvmm from "../../assets/image/specindustrialbalance/t7e-series1.png";
import Stand from "../../assets/image/specindustrialbalance/twi-700c.png";
import specFile from "../../assets/image/specindustrialbalance/T7E-spec.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            ELECTRONIC FLOOR SCALE T7E-SERIES 
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>Zepper T7E Series หัวอ่านแสดงผลน้ำหนักแบบดิจิตอลยอดนิยมที่ใช้กับเครื่องชั่งน้ำหนักตั้งพื้นขนาดใหญ่ (Floor Scale) โดยมีคุณสมบัติเด่นคือหน้าจอ LED สีแดงขนาดใหญ่ 2 นิ้ว มองเห็นได้ชัดเจนจากระยะไกล</li>
                  <li>• หน้าจอแสดงผล: LED สีแดงเรืองแสง (Bright Red LED) ขนาดใหญ่ สูง 2 นิ้ว (ประมาณ (50 mm))</li>
                  <li>• ความแม่นยำ: ความละเอียดสูงสุด 1/30,000</li>
                  <li>• การใช้งานไฟฟ้า: รองรับระบบไฟ 220 V และมีแบตเตอรี่แบบชาร์จไฟได้ในตัว (Rechargeable Battery)</li>
                  <li>• การเชื่อมต่อ: มีอุปกรณ์มาตรฐาน RS232C สำหรับเชื่อมต่อกับคอมพิวเตอร์หรือเครื่องพิมพ์</li>
                  <li>• พิกัดและขนาด: นิยมใช้กับแท่นชั่งขนาดใหญ่ ตั้งแต่ 500 kg - 5,000 kg (5 ตัน)</li>
                  <li>• รุ่นนี้มักผ่านการตรวจรับรองจากสำนักชั่งตวงวัด เหมาะสำหรับอุตสาหกรรมที่ต้องการความแม่นยำและความทนทาน</li>
                </ul>
              </div>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Tare Function: หักค่าน้ำหนักภาชนะได้เต็มพิกัด</li>
                  <li>• Zero Function: ตั้งค่าศูนย์</li>
                  <li>• Hold Function: ฟังก์ชันล็อคน้ำหนัก</li>
