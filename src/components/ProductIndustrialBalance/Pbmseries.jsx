...
import product1 from "../../assets/image/industrialbalance/BM-SERIES.png"
import specvmm from "../../assets/image/specindustrialbalance/bm-series1.png";
import Stand from "../../assets/image/specindustrialbalance/bm-series2.png";
import specFile from "../../assets/image/specindustrialbalance/BMSPEC.pdf";
import p1 from "../../assets/image/brandsale/47.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องชั่งความละเอียดสูง 5 ตำแหน่ง (0.01 mg) มาพร้อม Ionizer ในตัวสำหรับกำจัดไฟฟ้าสถิต โครงสร้างกระจกกันลมเคลือบโลหะนำไฟฟ้า ปรับเทียบภายในอัตโนมัติ (Internal Calibration) เหมาะสำหรับงานวิจัยที่ต้องการความแม่นยำสูง</li>
                  <li>• ความแม่นยำสูง: อ่านละเอียด (Readability) 0.01 mg (0.00001  g) </li>
                  <li>• Built-in Ionizer: มีตัวกำจัดไฟฟ้าสถิตแบบไร้พัดลมในตัว ช่วยกำจัดไฟฟ้าสถิตจากตัวอย่างและภาชนะได้ทันที ช่วยให้การชั่งสารที่เบาหรือเป็นผงมีความเสถียรและแม่นยำ</li>
