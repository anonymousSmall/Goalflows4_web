...
import product1 from "../../assets/image/industrialbalance/ap-w-series.png"
import specvmm from "../../assets/image/specindustrialbalance/ap-w-series2.png";
import Stand from "../../assets/image/specindustrialbalance/ap-w-series1.png";
import specFile from "../../assets/image/specindustrialbalance/APSPEC.pdf";
import p1 from "../../assets/image/brandsale/46.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Analytical Balance AP-W-SERIES
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เป็นเครื่องชั่งแบบ Top-loading ที่มีความแม่นยำสูง โดดเด่นเรื่องเทคโนโลยีเซนเซอร์ UniBloc AP ที่ช่วยให้ประมวลผลเร็วและคงที่</li>
                  <li>• เทคโนโลยีเซนเซอร์: UniBloc AP (One-piece sensor) ช่วยให้เสถียรภาพและความเร็วในการชั่งดีขึ้น</li>
