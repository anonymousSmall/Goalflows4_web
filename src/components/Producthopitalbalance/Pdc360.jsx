...
import product1 from "../../assets/image/hospitalbalance/DC-360.png"
import specvmm from "../../assets/image/spechospitalbalance/DC-360-1.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Body Composition Analyzer DC-360
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>TANITA DC-360 Series เป็นเครื่องวิเคราะห์องค์ประกอบร่างกาย (Body Composition Analyzer) ที่ใช้เทคโนโลยีขั้นสูง เหมาะสำหรับใช้ในคลินิก ฟิตเนส หรือการตรวจสุขภาพทั่วไป</li>
                  <li>• เทคโนโลยีการวัด: ใช้ระบบ Dual Frequency BIA (Bioelectrical Impedance Analysis) ซึ่งเป็นการวิเคราะห์ความต้านทานกระแสไฟฟ้าต่อเซลล์ในร่างกายสองความถี่ เพื่อความแม่นยำที่สูงขึ้นในการวัด</li>
                  <li>• การวิเคราะห์ข้อมูล: เครื่องสามารถวิเคราะห์ค่าต่าง ๆ ได้หลากหลาย เช่น:</li>
