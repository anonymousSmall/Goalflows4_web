...
import product1 from "../../assets/image/hospitalbalance/BW-3133.png"
import specvmm from "../../assets/image/spechospitalbalance/bw-3133-1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/BW-3133SPEC.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>NAGATA รุ่น BW-3133 เป็นเครื่องชั่งน้ำหนักแบบนั่งดิจิทัลคุณภาพสูง ออกแบบมาเพื่อผู้ป่วย ผู้สูงอายุ หรือผู้พิการ พิกัดกำลังสูงสุด 250 kg (ละเอียด 0.1 kg) มีเบาะนั่งและที่วางแขนพับได้เพื่อความสะดวกในการเคลื่อนย้าย พัฒนาโครงสร้างให้แข็งแรงทนทาน อ่านค่าง่ายด้วยจอ LCD </li>
