...
import product1 from "../../assets/image/hospitalbalance/BW-1410XXL.png"
import specvmm from "../../assets/image/spechospitalbalance/bw-1410xxl1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/BW-1410XXLSPEC.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            Body SCALE BW-1410XXL
        </h1>
        <p className="text-gray-500 mt-2 text-sm md:text-base">
            เครื่องชั่งน้ำหนักดิจิตอลสำหรับรถเข็นผู้ป่วย/เปลนอน
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักดิจิตอลสำหรับรถเข็นผู้ป่วย/เปลนอน [NAGATA รุ่น BW-1410XXL] เป็นเครื่องชั่งเกรดโรงพยาบาล ผลิตจากไต้หวัน ชั่งน้ำหนักได้สูงสุด 300 กิโลกรัม ความละเอียด 100 กรัม แท่นชั่งขนาดใหญ่100 X 170 ซม. พร้อมทางลาดและราวจับสแตนเลส เหมาะสำหรับรถเข็นผ่านได้สะดวก มีฟังก์ชันคำนวณ BMI และล็อคค่าน้ำหนัก</li>
                  {/*<li>• โครงสร้าง: แท่นชั่งขนาดประมาณ 355x360 มม. หรือ 370x370 มม. ปูพื้นกันลื่น</li>
                  <li>• การเคลื่อนย้าย: มีล้อคู่หลังช่วยให้เคลื่อนย้ายสะดวก</li>
                  <li>• พลังงาน: AC Adapter 12V / 500mA</li>
              ...
              {/* Application */}
               <div className="mb-6">
                <h3 className="font-semibold text-[#003b6e] mb-2">ฟังก์ชันการทำงาน: </h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• BMI: คำนวณดัชนีมวลกายอัตโนมัติ</li>
                  <li>• Hold/Recall: ล็อคค่าน้ำหนักหน้าจอและเรียกดูค่าน้ำหนักย้อนหลัง</li>
                  <li>• Tare: หักค่าน้ำหนักรถเข็นหรือสิ่งของอื่นๆ</li>
                  <li>• Stand-by: ปิดเครื่องอัตโนมัติเมื่อไม่ใช้งานเพื่อประหยัดพลังงาน</li>
