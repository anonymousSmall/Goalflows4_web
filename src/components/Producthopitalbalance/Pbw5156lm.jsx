...
import product1 from "../../assets/image/hospitalbalance/BW-5156LM.png"
import specvmm from "../../assets/image/spechospitalbalance/bw-5156lm1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/BW5156LMSPEC.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>NAGATA รุ่น BW-5156LM เป็นเครื่องชั่งน้ำหนักดิจิทัลสำหรับผู้ป่วยและรถเข็น (Wheelchair Scale) มาตรฐานไต้หวัน พิกัดน้ำหนัก 300 kgละเอียด0.1 kg(100 g) โดดเด่นด้วยฟังก์ชันคำนวณ BMI อัตโนมัติ จอ LCD มีแบคไลท์ และพื้นราบสำหรับเข็นรถเข็นขึ้นได้ง่าย เหมาะสำหรับโรงพยาบาลหรือศูนย์ฟื้นฟู</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• BMI: คำนวณค่าดัชนีมวลกาย (Body Mass Index) อัตโนมัติ</li>
                  <li>• Hold: ฟังก์ชันล็อกค่าน้ำหนักเพื่อบันทึกแม้คนไข้ลงจากแท่นชั่งแล้ว</li>
                  <li>• Tare: ฟังก์ชันหักน้ำหนักรถเข็นหรือภาชนะ</li>
                  <li>• Auto Stand-by: ระบบปิดหน้าจออัตโนมัติเมื่อไม่ใช้งานเพื่อประหยัดพลังงาน</li>
