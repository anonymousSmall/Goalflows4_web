...
import product1 from "../../assets/image/hospitalbalance/HD-380.png"
import specvmm from "../../assets/image/spechospitalbalance/HD-380-1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/HD-380SPEC.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>Tanita HD-380 เป็นเครื่องชั่งน้ำหนักบุคคลระบบดิจิทัลดีไซน์บางเฉียบ (Ultra Slim) เพียง 22 มม. ชั่งน้ำหนักสูงสุดได้ 150 กก. ความละเอียด 100 กรัม ผลิตจากกระจกนิรภัยแข็งแรงทนทาน (Safety Glass) จอ LCD อ่านง่าย 30 มม. ใช้งานง่ายด้วยระบบ Tap-on เปิดอัตโนมัติเมื่อขึ้นชั่ง ใช้พลังงานจากแบตเตอรี่</li>
                  <li>• เหมาะสำหรับใช้ชั่งน้ำหนักในบ้าน ดีไซน์สวยงาม ทนทานตามมาตรฐาน</li>
