...
import product1 from "../../assets/image/hospitalbalance/IDS851.png"
import specvmm from "../../assets/image/spechospitalbalance/ids851-1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/IDS851PEC.pdf";
import p1 from "../../assets/image/brandsale/42.png";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        ...
        <p className="text-gray-500 mt-2 text-sm md:text-base">
            เครื่องชั่งน้ำหนักบุคคลดิจิตอลพร้อมที่วัดส่วนสูง
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักบุคคลดิจิตอลพร้อมที่วัดส่วนสูง ยี่ห้อ SDS รุ่น IDS851 (หรือ IDS851 Series) เป็นเครื่องชั่งน้ำหนักแบบดิจิตอลที่ออกแบบมาสำหรับการใช้งานในสถานพยาบาล โรงพยาบาล หรือฟิตเนส</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Hold: ฟังก์ชันล็อคค่าน้ำหนักอัตโนมัติ</li>
                  <li>• BMI: คำนวณค่าดัชนีมวลกาย (Body Mass Index)</li>
                  <li>• Zero/Tare: หักค่าน้ำหนักส่วนเกิน หรือตั้งค่าหน้าจอเป็นศูนย์</li>
                  <li>• Unit: สามารถเปลี่ยนหน่วยการชั่งได้ เช่น กิโลกรัม (kg) หรือ ปอนด์ (lb)</li>
