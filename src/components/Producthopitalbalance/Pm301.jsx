...
import product1 from "../../assets/image/hospitalbalance/M301.png"
import specvmm from "../../assets/image/spechospitalbalance/m301-1.png";
import Stand from "../../assets/image/spechospitalbalance/DC-360-1.png";
import specFile from "../../assets/image/spechospitalbalance/M-301SPEC.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        ...
        <p className="text-gray-500 mt-2 text-sm md:text-base">
            เครื่องชั่งน้ำหนักบุคคลระบบดิจิตอลพร้อมชุดวัดส่วนสูง
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>TSCALE M301 เป็นเครื่องชั่งน้ำหนักบุคคลระบบดิจิตอลพร้อมชุดวัดส่วนสูง พิกัดกำลังสูงสุด 250 กิโลกรัม ความละเอียด 0.1 กิโลกรัม (100 กรัม) โดดเด่นด้วยฟังก์ชันคำนวณค่าดัชนีมวลกาย (BMI) หน้าจอ LCD เรืองแสงขนาด 25 มม. โครงสร้างแข็งแรงทนทานพร้อมแผ่นยางกันลื่น เหมาะสำหรับใช้งานในสถานพยาบาลหรือฟิตเนส</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• คำนวณค่าดัชนีมวลกาย (BMI) พร้อมแถบบาร์กราฟแสดงผล</li>
                  <li>• ระบบ HOLD ล็อคค่าน้ำหนักอัตโนมัติ</li>
