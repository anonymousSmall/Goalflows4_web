...
import product1 from "../../assets/image/animalbalance/TAS-01.png"
import specvmm from "../../assets/image/specanimalbalance/tas01spec.png";
import Stand from "../../assets/image/specanimalbalance/bw-7842spec.pdf";
import specFile from "../../assets/image/specanimalbalance/TAS-01spec.pdf";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักสัตว์ TIGER รุ่น TAS-01 เป็นเครื่องชั่งดิจิตอลสำหรับสัตว์เลี้ยงหรือสัตว์ขนาดใหญ่ พิกัดน้ำหนักสูงสุด 300 kg ความละเอียด 0.05 kg(50 กรัม) แท่นชั่งขนาด 50 x 90 ซม. พร้อมแผ่นกันลื่น มีฟังก์ชันล็อกน้ำหนัก (Hold) สำหรับสัตว์ที่เคลื่อนไหว แสดงผล LCD แบตเตอรี่ในตัวชาร์จได้ และมีล้อเลื่อนสะดวกในการเคลื่อนย้า</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Animal Scale Mode: มีโหมดชั่งน้ำหนักสัตว์เลี้ยงโดยเฉพาะ ช่วยจับน้ำหนักแม้สัตว์จะเคลื่อนไหว</li>
                  <li>• Hold Function: ฟังก์ชันล็อกน้ำหนักสัตว์</li>
                  <li>• TARE: ฟังก์ชันหักค่าน้ำหนักภาชนะ</li>
