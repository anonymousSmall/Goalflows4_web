...
import product1 from "../../assets/image/animalbalance/ac-168.png"
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่อง ชั่งสัตว์ เครื่องชั่งสัตว์เลี้ยง เครื่องชั่งน้ำหนักสัตว์ ขั่งน้ำหนักได้ 300 kg ค่าละเอียด 0.1g ยี่ห้อ ACU ACU-168 300kg 0.1kg</li>
