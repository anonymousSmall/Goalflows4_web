...
import product1 from "../../assets/image/animalbalance/animalsmall.png"
import specvmm from "../../assets/image/specanimalbalance/animalsmall.png";
import Stand from "../../assets/image/specanimalbalance/bw-7842spec.pdf";
import specFile from "../../assets/image/specanimalbalance/animalsmall.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
            เครื่องชั่งน้ำหนักสัตว์เล็กแบบกรง
        </h1>
        <p className="text-gray-500 mt-2 text-sm md:text-base">
          เครื่องชั่งน้ำหนักวัว สุกร ปศุสัตว์ แบบกรง คอก ชั่งทีละตัว
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักสุกร (หมู) เป็นเครื่องชั่งระบบอิเล็กทรอนิกส์/ดิจิตอลที่ออกแบบมาเพื่องานปศุสัตว์โดยเฉพาะ มีคุณสมบัติเด่นคือโครงสร้างแข็งแรงทนทาน (มักเป็นเหล็กหรือสแตนเลส) มีกรงขังเพื่อป้องกันหมูวิ่งหนี รับน้ำหนักได้สูงตั้งแต่ 300 - 2,000 กก. มาพร้อมฟังก์ชันล็อคน้ำหนัก (Hold) เพื่ออ่านค่าได้แม่นยำแม้สัตว์ขยับตัว และมักมีระบบล้อเลื่อนเคลื่อนที่ได้สะดวก</li>
...
export default Panimalsmallsize