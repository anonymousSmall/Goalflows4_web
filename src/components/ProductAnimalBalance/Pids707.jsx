...
import product1 from "../../assets/image/animalbalance/IDS707 (VET SCALE).png"
import specvmm from "../../assets/image/specanimalbalance/ids707.png";
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักสัตว์เลี้ยงดิจิตอล SDS รุ่น IDS707 (VET SCALE) พิกัด 300 กิโลกรัม ละเอียด 50 กรัม เหมาะสำหรับสัตว์เลี้ยงขนาดกลาง-ใหญ่ ตัวแท่นทำจากสแตนเลสทนทาน มีฟังก์ชันล็อคน้ำหนักอัตโนมัติ (Animal Weighing) เมื่อสัตว์เคลื่อนไหว หน้าจอแสดงผลเรืองแสง (Backlight) ชัดเจน และใช้งานแบบไร้สายได้ด้วยแบตเตอรี่รีชาร์จ</li>
              ...
              {/* Application */}
               <div className="mb-6">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Tare: หักค่าภาชนะหรือถาด</li>
                  <li>• Zero: ตั้งค่าเป็นศูนย์</li>
                  <li>• Auto Off: ระบบปิดอัตโนมัติเมื่อไม่ใช้งาน ช่วยประหยัดพลังงาน</li>
                </ul>
              </div>
