...
import product1 from "../../assets/image/animalbalance/กรงใหญ่.png"
import specvmm from "../../assets/image/specanimalbalance/animalbig.png";
import Stand from "../../assets/image/specanimalbalance/bw-7842spec.pdf";
import specFile from "../../assets/image/specanimalbalance/animalbig.pdf";
    ...
    <section className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-10 px-4 md:px-10">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-[#003b6e] tracking-wide">
          เครื่องชั่งน้ำหนักสัตว์ใหญ่แบบกรง
        </h1>
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 leading-relaxed">
                  <li>เครื่องชั่งน้ำหนักวัวในฟาร์มส่วนใหญ่เป็นระบบอิเล็กทรอนิกส์/ดิจิตอล โครงสร้างแข็งแรงทนทานทำจากเหล็กคาร์บอนหรือสแตนเลส (กรง/แท่นชั่ง) พิกัดชั่งสูงสุด 1,000-2,000 กก. มีความแม่นยำสูง (ค่าละเอียด0.5-1 กก.) โดยใช้โหลดเซลล์ 4 ตัว (Loadcell) รองรับการชั่งแม้สัตว์เคลื่อนไหว มีจอแสดงผล LED/LCD แบตเตอรี่ในตัวชาร์จไฟได้ และมักมีการออกแบบแบบกรงขัง</li>
